...
from decimal import *
getcontext().prec = 28
from math import sqrt, log, radians, sin, cos, tan, sinh, cosh, atan
import os
import csv
...
def geo2grid(lat, long):
    ...
    return zone, str(round(E, 5)), str(round(N, 5))
