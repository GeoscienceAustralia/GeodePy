...
from geodepy.angles import angular_typecheck
...
class CoordCart(object):
    ...
    """
    def __init__(self, xaxis, yaxis, zaxis, nval=0):
        """
...
class CoordGeo(object):
    ...
    (typically a geoid).
    """
    def __init__(self, lat, lon, ell_ht=0, orth_ht=0):
        """
...
class CoordTM(object):
    ...
    """
    def __init__(self, zone, east, north, ell_ht=0, orth_ht=0,
