...
def interp_DOVPV(Lat,Long):
    ...
    f = gdal.Open('/vsicurl/https://geoid.s3-ap-southeast-2.amazonaws.com/AVWS/DOV_PV.tif')
...
def interp_DOVPM(Lat,Long):
    # Import the DOVPM file
    f = gdal.Open('/vsicurl/https://geoid.s3-ap-southeast-2.amazonaws.com/AVWS/DOV_PM.tif')
    # load band (akin to a variable in dataset)
    band = f.GetRasterBand(1)   
    # get the pixel width, height, etc.
    transform = f.GetGeoTransform()
...
def interp_AUSGeoid2020(Lat,Long):
    # open geotiff file
    f = gdal.Open('/vsicurl/https://geoid.s3-ap-southeast-2.amazonaws.com/AVWS/AUSGeoid2020_RELEASEV20170908.tif')
    # load band (akin to a variable in dataset)
    band = f.GetRasterBand(1)   
    # get the pixel width, height, etc.
    transform = f.GetGeoTransform()
...
def interp_AUSGeoid2020_STD(Lat,Long):
    # open geotiff file
    f = gdal.Open('/vsicurl/https://geoid.s3-ap-southeast-2.amazonaws.com/AVWS/AUSGeoid2020_RELEASEV20170908_err.tif')
    # load band (akin to a variable in dataset)
    band = f.GetRasterBand(1)   
    # get the pixel width, height, etc.
    transform = f.GetGeoTransform()
...
def interp_AVWS(Lat,Long):
    # open geotiff file
    f = gdal.Open('/vsicurl/https://geoid.s3-ap-southeast-2.amazonaws.com/AVWS/AVWS_20191107.tif')
...
def interp_AVWS_STD(Lat,Long):
    # open geotiff file
    f = gdal.Open('/vsicurl/https://geoid.s3-ap-southeast-2.amazonaws.com/AVWS/AVWS_STD_20191107.tif')
    # load band (akin to a variable in dataset)
    band = f.GetRasterBand(1)   
    # get the pixel width, height, etc.
    transform = f.GetGeoTransform()
